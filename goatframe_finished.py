...
def goatframe (image, percentborder):
    ...
    goatfile = os.path.join(directory, 'goat.png')
    goatimg = PIL.Image.open(goatfile)
    gwidth, gheight = goatimg.size
    logosmall = goatimg.resize((borderlength*3,borderlength*3*gheight/gwidth))
    gheight = borderlength*3*gheight/gwidth
    gwidth= borderlength*3
    result.paste(logosmall, (width-gwidth,height-gheight))
